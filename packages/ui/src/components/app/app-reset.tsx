  ...
  return (
    <div className="flex h-screen w-full items-center justify-center p-6">
      <div className="flex flex-col items-center gap-8 text-center w-lg">
        ...
        <h2 className="text-4xl text-foreground">Mycel updated</h2>
        <div className="space-y-2">
          <p className="text-sm text-muted-foreground">
            Mycel has been upgraded to a new version and needs to reset local
            app data to ensure compatibility.
          </p>
          <p className="text-sm text-muted-foreground">
            You will need to log in again to continue using Mycel.
          </p>
        </div>
        <Button
          variant="outline"
